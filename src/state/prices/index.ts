...
const getTasteYUMMYPrice = async () => {
  try {
    const { data } = await axios.get(`https://api.pancakeswap.info/api/v2/tokens/0xB003C68917BaB76812797d1b8056822f48E2e4fe`)
...
const getSokuPrice = async () => {
  ...
  try {
    const { data } = await axios.get(`https://api.pancakeswap.info/api/v2/tokens/0x0e4b5ea0259eb3d66e6fcb7cc8785817f8490a53`)
